...
from ..inducing_variables import InducingPoints, InducingVariables, SymRectangularSpectralInducingPoints, IFFRectangularSpectralInducingPoints
...
def inducingpoint_wrapper(inducing_variable: InducingVariablesLike) -> InducingVariables:
    ...
    if isinstance(inducing_variable, SymRectangularSpectralInducingPoints):
        pass
    elif isinstance(inducing_variable, IFFRectangularSpectralInducingPoints):
        pass
