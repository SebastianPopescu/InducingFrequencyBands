...
class FallbackSeparateIndependentInducingVariables(MultioutputInducingVariables):
    ...
    def num_inducing(self) -> tf.Tensor:
        return self.inducing_variable_list[0].num_inducing #TODO -- shouldn't this be a list here
        # in the case that we have varying num_inducing for different inducing variables
