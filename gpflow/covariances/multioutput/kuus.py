...
@Kuu.register(FallbackSharedIndependentSpectralInducingVariables, SharedIndependent)
@check_shapes(
    "inducing_variable: [M, D, P]",
    "return: [M, M]",
)
def Kuu_spectral_shared_shared(
    inducing_variable: FallbackSharedIndependentSpectralInducingVariables,
    kernel: SharedIndependent,
    *,
    jitter: float = 0.0,
) -> tf.Tensor:
