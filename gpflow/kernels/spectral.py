...
class DecomposedMultipleDiracSpectralBlock(DecomposedAnisotropicSpectralStationary):

    """
    TODO -- update the documentation.
    The primitive kernel defined by multiple constant spectral density spanning finite Dirac delta bandwidths.
    To be used for Inducing Frequency Bands models and gp-multiSinc, in the case that the spectral blocks are 
    Dirac deltas.
    Works with multi-dimensional data by taking a product over symmetrical rectangles for each input dimension.
    ...
    def K_d(self, d):
        ...
        #NOTE -- I think in this case the sinc part is just 1. Need to double check the maths
